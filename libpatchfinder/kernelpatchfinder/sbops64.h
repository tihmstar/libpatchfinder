...
//  libpatchfinder
//
//  Created by tihmstar on 11.06.22.
//
...
struct mac_policy_ops {
    ...
    uint64_t mpo_proc_check_syscall_unix;
    ...
    uint64_t mpo_mount_check_mount_late;
    uint64_t mpo_mount_check_snapshot_mount;
    ...
    uint64_t mpo_proc_check_dump_core;
