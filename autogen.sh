...
CFLAGS+=" -DIMG4TOOL_NOMAIN -I$PWD/external/libplist/include"
CXXFLAGS+=" -DIMG4TOOL_NOMAIN -I$PWD/external/libplist/include"
export LDFLAGS+="-L$PWD/external/libplist/src"

CONFIGURE_FLAGS="--without-cython --without-openssl \
  --without-lzfse \
  $@"
